...
public class TeacherOrStudentProfileActivity extends AppCompatActivity {
    ...
    private TeacherLessonsListAdapter teacherAdapter;
    private StudentLessonsListAdapter studentAdapter;
                ...
                public void onResponse(JSONArray response) {
                    try {
                        ...
                        if (status == 200) {
                            ...
                            if (isStudent) {
                                for (int i = studentLessonsList.size(); i < lessons.length(); ++i) {
                                ...
                                if (studentAdapter == null) {
                                    studentAdapter = new StudentLessonsListAdapter(TeacherOrStudentProfileActivity.this, studentLessonsList);
                                ...
                                for (int i = teacherLessonsList.size(); i < lessons.length(); ++i) {
                                    JSONObject lesson = (JSONObject)lessons.get(i);
                                ...
                                if (teacherAdapter == null) {
                                    teacherAdapter = new TeacherLessonsListAdapter(TeacherOrStudentProfileActivity.this, teacherLessonsList);
