...
public class StudentLessonActivity extends AppCompatActivity {
    ...
    private static StudentLessonFragmentStatePagerAdapter adapter;
    private static ImageButton dontUnderstand;
    private ImageButton record;
    private static Button name;
    private static Button anonymously;
    ...
    public static Handler answerDiscussionHandler;
    public static Handler deleteDiscussionHandler;
    public static Handler addDiscussionHandler;
    public static Handler muteHandler;
    public static Handler unmuteHandler;

    static {
        answerDiscussionHandler = new Handler() {

            @Override
            public void handleMessage(Message msg) {
                if (adapter != null) {
                    adapter.answerDiscussion((Integer)msg.obj);
                }
            }
        };

        deleteDiscussionHandler = new Handler() {

            @Override
            public void handleMessage(Message msg) {
                if (adapter != null) {
                    adapter.deleteDiscussion((Integer)msg.obj);
                }
            }
        };

        addDiscussionHandler = new Handler() {
